...
Object::Object(const vk::raii::Device& device, const vk::raii::PhysicalDevice& physicalDevice, std::vector<Vertex> vertices)
...
void Object::bind(vk::raii::CommandBuffer& commandBuffer)
{
